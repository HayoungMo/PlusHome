...
const FurnitureList = () => {
	...
	useEffect(() => {
		...
		LikeService.getMyFurnitureLikes()
			.then((res) => {
				const likedCodes = new Set((res.data || []).map((item) => item.f_code));
			...
			<div className="furniture-list-page">
				...
				{loading ? (
					<div
						...
						<SkeletonMui variant="furnitureCard" count={4} />
					</div>
				) : list.length === 0 ? (
					<div
						style={{
										...
										<div
											...
											<span
												...
												style={{
													...
													pointerEvents: likingMap[item.f_code]
														? "none"
														: "auto",
