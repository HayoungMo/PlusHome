    ...
    <div className="join-wrap">
      <div className="join-box">
        ...
        <div className="join-input">
          ...
          {errorMsg.idFormat && (
            <div className="error-msg">{errorMsg.idFormat}</div>
          )}

          <div className="guide-msg">아이디에 한글은 입력할 수 없습니다.</div>
              ...
              endAdornment: (
                <InputAdornment position="end">
                  <IconButton
                    ...
                    edge="end"
                  >
                    {showPwCheck ? <Visibility /> : <VisibilityOff />}
                  </IconButton>
                </InputAdornment>
              ),
            }}
        ...
        {form.type === "company" && (
          <>
            ...
            {errorMsg.c_name && (
              <div className="error-msg">{errorMsg.c_name}</div>
            )}
            
            <div className="address-wrap">
              <AddressSearchForm isC={true} form={form} setForm={setForm} />
            </div>

            {errorMsg.c_addr && (
              <div className="error-msg">{errorMsg.c_addr}</div>
            )}
        ...
        <div className="address-wrap">
          <AddressSearchForm
            title="주소"
            description="주소 검색 버튼을 눌러 상세주소를 입력하세요."
            form={form}
            setForm={setForm}
          />
        </div>
